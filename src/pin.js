...
const { DEFAULT_THEME, BREAK_SIZE, PIN_HEIGHT, PIN_STATS_Y, CHARS_WRAP } = CONSTANTS; // get constants
...
export const getPin = (query, gist_response) => {
  ...
  let description = wrapDescription(gist.description, CHARS_WRAP); // wrap description
